...
def test_create_user_with_email_successful(time_tracker) -> None:
    """
...
def test_new_user_without_email_raises_error(time_tracker) -> None:
...
def test_new_user_without_username_raises_error(time_tracker) -> None:
...
def test_create_superuser(time_tracker) -> None:
...
def test_new_superuser_with_wrong_extra_field_raises_error(time_tracker) -> None:
    """
    Test that creating a superuser false 'is_superuser' field raises a ValueError.
    :return: None
    """
